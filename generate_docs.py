...
def generate_docs(dct_descr:dict,data_df:pd.DataFrame,source_folder:str,destination_folder:str,type_program:str):
    ...
    # словарь для значения типа программы в винительном падеже
    where_type_program = {
        'Повышение квалификации': 'повышение квалификаци',
        'Профессиональная переподготовка': 'профессиональную переподготовку',
        'Программа профессиональной подготовки по профессии рабочего, должности служащего': 'программу профессиональной подготовки по профессии рабочего,должности служащего',
        'Программа переподготовки рабочих, служащих': 'программу переподготовки рабочих, служащих',
        'Программа повышения квалификации рабочих, служащих': 'программу повышения квалификации рабочих, служащих', }
    dct_descr['Тип_программы_Вин_П'] = where_type_program[dct_descr['Тип_программы']]
